...
>
> **Scope:** Template repo `workflow-orchestration-queue-kilo15-a` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
