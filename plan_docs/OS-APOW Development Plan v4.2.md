...
* **Story 1: Template Cloning & Plan Seeding**  
  * **As a** Developer, **I want** to manually clone the workflow-orchestration-queue-kilo15-a and seed it with these plan documents in the /docs directory, **so that** the AI agents have the necessary context to start building the orchestrator.  
  * **Acceptance Criteria:**  
...
* **Story 3: Shell-Bridge Dispatcher**  
  ...
  * **Rationale:** By piping the task into the existing shell bridge, we inherit all the SSH-agent forwarding, volume mounts, and Docker network configurations defined in the workflow-orchestration-queue-kilo15-a.  
  * **Acceptance Criteria:**  
...
1. **Stage 0 (Seeding):** The developer manually clones the workflow-orchestration-queue-kilo15-a. This plan is added to /docs.  
